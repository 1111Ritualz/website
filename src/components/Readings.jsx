...
const Readings = () => {
    return (
        <div style={{ backgroundColor: 'var(--color-cream)', minHeight: '100vh' }}>
            ...
            {/* ── THE RITUAL MAKERS ── */}
            <section style={{ backgroundColor: '#f5f0e8', padding: '8rem 2rem' }}>
                <div style={{ maxWidth: '900px', margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
                        <p style={{ color: 'var(--color-gold)', letterSpacing: '3px', fontSize: '0.8rem', textTransform: 'uppercase', marginBottom: '1rem' }}>
                            Our Story
                        </p>
                        <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '2.8rem' }}>
                            The Ritual Makers
                        </h2>
                    </div>
                    ...
                    <div style={{
                        ...
                        <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: 'var(--color-text-light)' }}>
                            <strong style={{ color: 'var(--color-dark)' }}>It did not start as a brand.</strong> It started in a bathtub in London.
                        </p>
                        <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: 'var(--color-text-light)' }}>
                            What began as curiosity around salt, spices, and their deeper meanings quickly turned into something more.
                            Shantana had always been drawn to the idea that simple ingredients could carry intention,
                            and together with Rakshit, that curiosity turned into quiet experimentation.
                        </p>
                        <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: 'var(--color-text-light)' }}>
                            It always began with one question: <em>"How are you feeling today?"</em> From there, they would create blends to match
                            the moment. A little of this, a little of that, but always intentional. Somewhere along the way, those baths stopped
                            being just baths. They became rituals.
                        </p>
                        <p style={{ fontFamily: 'var(--font-serif)', fontSize: '1.3rem', color: 'var(--color-dark)' }}>
                            And the shift: Subtle but real.
                        </p>
                        <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: 'var(--color-text-light)' }}>
                            That's when they knew this couldn't stay personal. Today, Shantana, a dentist-turned-marketeer,
                            and Rakshit, an Aerospace Engineer with a curious mind, are building 11:11 Ritualz…
                            bringing that same simple, powerful ritual into everyday life.
                        </p>
                    </div>
                </div>
            </section>
